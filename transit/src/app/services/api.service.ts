...
export class ApiService {
  private apiUrl = 'https://cdb8a58cd137.ngrok-free.app/api';
  ...
  private getHeaders(): HttpHeaders {
    ...
    if (this.apiUrl && this.apiUrl.includes('ngrok-free.app')) {
        console.log('ApiService: Detected ngrok URL, adding skip warning header');
        headersConfig['ngrok-skip-browser-warning'] = 'any_value'; // Value can be anything
        // Optional: Add User-Agent if preferred:
        // headersConfig['User-Agent'] = 'TransitTrackApp-Ionic';
    }
    // --- END NGROK BYPASS ---
